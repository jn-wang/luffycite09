# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-05-11 08:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupon_type', models.SmallIntegerField(choices=[(0, '通用卷'), (1, '满减卷'), (2, '折扣卷')], default=0, verbose_name='卷类型')),
                ('money_equivalent_value', models.IntegerField(verbose_name='等值货币')),
                ('off_percent', models.PositiveSmallIntegerField(blank=True, help_text='只针对折扣卷，例7.9折，写79', null=True, verbose_name='折扣百分比')),
                ('minimum_consume', models.PositiveIntegerField(default=0, help_text='仅在减慢卷时填写此字段', verbose_name='最低消费')),
                ('object_id', models.PositiveIntegerField(blank=True, help_text='可以将优惠卷与课程绑定', null=True, verbose_name='绑定课程')),
                ('quantity', models.PositiveIntegerField(default=1, verbose_name='数量（张）')),
                ('open_date', models.DateField(verbose_name='优惠卷领取开始时间')),
                ('close_date', models.DateField(verbose_name='优惠卷领取结束时间')),
                ...
                ('coupon_valid_days', models.PositiveIntegerField(blank=True, help_text='卷被领取时算起', null=True, verbose_name='优惠卷有效期（天）')),
